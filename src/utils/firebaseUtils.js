...
export const fetchProducts = async (pageSize = 10, startAfterDoc = null, category = '', subCategory = '', sortBy = 'quantity') => {
...
export const selectfetchProducts = async (category = '', subCategory = '', sortBy = 'quantity') => {
  if (!category) {
    return [];
  } 
  try {
